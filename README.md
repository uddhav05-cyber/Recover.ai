...
Requirements: Python 3.13 and Node.js 20+. Docker Desktop is optional.

### Windows Without Docker

The development environment can use the configured hosted Postgres database,
so Docker is not needed for a local dashboard demo. From the repository root,
...
Open `http://localhost:8080`. The launcher starts FastAPI on port 8000 and Vite
on port 8080 in separate processes.
